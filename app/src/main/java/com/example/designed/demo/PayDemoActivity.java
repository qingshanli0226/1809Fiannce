package com.example.designed.demo;
...
import com.example.designed.demo.util.OrderInfoUtil2_0;
		...
		public void handleMessage(Message msg) {
			...
			case SDK_PAY_FLAG: {
				...
				if (TextUtils.equals(resultStatus, "9000")) {
					...
					startActivity(new Intent(PayDemoActivity.this, WelcomeActivity.class));
