...
public class ProductBean {
    ...
    public static class ResultBean {
        ...
        public ResultBean(String id, String name, String money, String yearRate, String suodingDays, String minTouMoney, String memberNum, String progress) {
            this.id = id;
            this.name = name;
            this.money = money;
            this.yearRate = yearRate;
    ...
    public ProductBean(Integer code, String msg, List<ResultBean> result) {
        this.code = code;
        this.msg = msg;
        this.result = result;
    }
