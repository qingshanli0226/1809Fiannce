...
import com.example.net.FiannceApiService;
...
public class RetrofitManager {
    ...
    public static FiannceApiService getApi() {
        if (fiannceApiService==null){
            fiannceApiService=getRetrofit();
        }
        return fiannceApiService;
    }

    public static FiannceApiService getRetrofit() {
