...
public class FianceManager {
    ...
    private static FianceManager fianceManager;

    public static synchronized FianceManager getInstance() {
        if (fianceManager == null) {
            fianceManager = new FianceManager();
        }
        return fianceManager;
    }
}
